...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(AutorExitenteException.class)
	public ResponseEntity<DetalhesErro> handleAutorExitenteException(AutorExitenteException e,
			HttpServletRequest request) {

		DetalhesErro erro = new DetalhesErro();
		erro.setStatus(409l);
		erro.setTitulo("Autor já existestnte");
